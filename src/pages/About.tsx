				...
				<div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
					...
					<div className="mt-10 text-left max-w-2xl dark:text-slate-300">
						<p>
							...
							tracking solutions, and business ops management software in my
							spare time.{" "}
						</p>
						<span>
							<br></br>
						...
						<p>
							...
							don&apos;t take on a lot of freelance development work, but
							I&apos;m particularly passionate about helping small businesses
							and niche industries use technology and automation to supercharge
							their operations - so if that sounds like something you&apos;re
							looking for in a developer, I&apos;m always open to networking and
						...
						<ul
							...
							<li className="flex gap-x-3">
								...
								<span>
									...
									I like to work with people who are quick to adapt and learn
									new things, and who follow their intuition.
								</span>
							</li>
							<li className="flex gap-x-3">
								<CheckCircleIcon
